...
/**
 * CreateTransferRequestBeneficiaryDetailsBeneficiaryContactDetails Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateTransferRequestBeneficiaryDetailsBeneficiaryContactDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateTransferRequest_beneficiary_details_beneficiary_contact_details';
    ...
    */
     ...
     *
     * @param string|null $beneficiary_phone It is the phone number of the beneficiary. Only registered Indian phone numbers are allowed. The value should be between 8 and 12 characters after stripping +91.
     *
     * @return self
     */
     ...
     *
     * @param string|null $beneficiary_address It should contain the address of the beneficiary. The maximum character limit is 150. Alphanumeric characters and whitespaces are allowed.
     *
     * @return self
     */
     ...
     *
     * @param string|null $beneficiary_city It is the name of the city as present in the beneficiary address. The maximum character limit is 50. Alphanumeric characters and whitespaces are allowed.
     *
     * @return self
     */
     ...
     *
     * @param string|null $beneficiary_state It is the name of the state as present in the beneficiary address. The maximum character limit is 50. Alphanumeric characters and whitespaces are allowed.
     *
     * @return self
     */
     ...
     *
     * @param string|null $beneficiary_postal_code It is the PIN code as present in the address. It should be a 6 character numeric value.
     *
     * @return self
     */
