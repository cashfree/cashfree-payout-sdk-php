 ...
 */
class CreateBeneficiaryRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateBeneficiaryRequest';
    ...
    protected static $openAPITypes = [
        ...
        'beneficiary_instrument_details' => '\Cashfree\Model\CreateBeneficiaryRequestBeneficiaryInstrumentDetails',
        'beneficiary_contact_details' => '\Cashfree\Model\CreateBeneficiaryRequestBeneficiaryContactDetails'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['beneficiary_id']) > 50)) {
            $invalidProperties[] = "invalid value for 'beneficiary_id', the character length must be smaller than or equal to 50.";
        }

        if ($this->container['beneficiary_name'] === null) {
            $invalidProperties[] = "'beneficiary_name' can't be null";
        }
        if ((mb_strlen($this->container['beneficiary_name']) > 100)) {
            $invalidProperties[] = "invalid value for 'beneficiary_name', the character length must be smaller than or equal to 100.";
        }
     ...
     * Sets beneficiary_id
     *
     * @param string $beneficiary_id It is the unique ID you create to identify the beneficiary. Alphanumeric, underscore ( _ ), pipe ( | ), and dot ( . ) are allowed.
     *
     * @return self
     */
    public function setBeneficiaryId($beneficiary_id)
    {
        ...
        if ((mb_strlen($beneficiary_id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $beneficiary_id when calling CreateBeneficiaryRequest., must be smaller than or equal to 50.');
        }
     ...
     *
     * @param string $beneficiary_name It is the name of the beneficiary. The maximum character limit is 100. Only alphabets and whitespaces are allowed.
     *
     * @return self
     */
    public function setBeneficiaryName($beneficiary_name)
    {
        ...
        if ((mb_strlen($beneficiary_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $beneficiary_name when calling CreateBeneficiaryRequest., must be smaller than or equal to 100.');
        }
     ...
     *
     * @return \Cashfree\Model\CreateBeneficiaryRequestBeneficiaryInstrumentDetails|null
     */
     ...
     *
     * @param \Cashfree\Model\CreateBeneficiaryRequestBeneficiaryInstrumentDetails|null $beneficiary_instrument_details beneficiary_instrument_details
     *
     * @return self
     */
     ...
     *
     * @return \Cashfree\Model\CreateBeneficiaryRequestBeneficiaryContactDetails|null
     */
     ...
     *
     * @param \Cashfree\Model\CreateBeneficiaryRequestBeneficiaryContactDetails|null $beneficiary_contact_details beneficiary_contact_details
     *
     * @return self
     */
