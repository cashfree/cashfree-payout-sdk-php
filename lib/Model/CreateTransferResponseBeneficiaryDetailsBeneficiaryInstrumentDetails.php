<?php
/**
 * CreateTransferResponseBeneficiaryDetailsBeneficiaryInstrumentDetails
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * CreateTransferResponseBeneficiaryDetailsBeneficiaryInstrumentDetails Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateTransferResponseBeneficiaryDetailsBeneficiaryInstrumentDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateTransferResponse_beneficiary_details_beneficiary_instrument_details';
    ...
    */
     ...
     *
     * @param string|null $bank_account_number It displays the bank account number of the beneficiary.
     *
     * @return self
     */
     ...
     * Sets ifsc
     *
     * @param string|null $ifsc It displays the IFSC information of the beneficiary's bank account.
     *
     * @return self
     */
